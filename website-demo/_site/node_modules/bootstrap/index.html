...
<ul>
  <li><a href="https://github.com/twbs/bootstrap/archive/v4.3.1.zip">Download the latest release.</a></li>
  ...
  <li>Install with <a href="https://yarnpkg.com/">yarn</a>: <code class="language-plaintext highlighter-rouge">yarn add bootstrap@4.3.1</code></li>
  <li>Install with <a href="https://getcomposer.org/">Composer</a>: <code class="language-plaintext highlighter-rouge">composer require twbs/bootstrap:4.3.1</code></li>
...
<p>Read the <a href="https://getbootstrap.com/docs/4.3/getting-started/introduction/">Getting started page</a> for information on the framework contents, templates and examples, and more.</p>

<h2 id="status">Status</h2>

<p><a href="https://bootstrap-slack.herokuapp.com/"><img src="https://bootstrap-slack.herokuapp.com/badge.svg" alt="Slack" /></a>
<a href="https://travis-ci.org/twbs/bootstrap"><img src="https://img.shields.io/travis/twbs/bootstrap/v4-dev.svg" alt="Build Status" /></a>
<a href="https://www.npmjs.com/package/bootstrap"><img src="https://img.shields.io/npm/v/bootstrap.svg" alt="npm version" /></a>
<a href="https://rubygems.org/gems/bootstrap"><img src="https://img.shields.io/gem/v/bootstrap.svg" alt="Gem version" /></a>
<a href="https://atmospherejs.com/twbs/bootstrap"><img src="https://img.shields.io/badge/meteor-twbs%3Abootstrap-blue.svg" alt="Meteor Atmosphere" /></a>
<a href="https://packagist.org/packages/twbs/bootstrap"><img src="https://img.shields.io/packagist/vpre/twbs/bootstrap.svg" alt="Packagist Prerelease" /></a>
<a href="https://www.nuget.org/packages/bootstrap/absoluteLatest"><img src="https://img.shields.io/nuget/vpre/bootstrap.svg" alt="NuGet" /></a>
<a href="https://david-dm.org/twbs/bootstrap?type=peer"><img src="https://img.shields.io/david/peer/twbs/bootstrap.svg" alt="peerDependencies Status" /></a>
<a href="https://david-dm.org/twbs/bootstrap?type=dev"><img src="https://img.shields.io/david/dev/twbs/bootstrap.svg" alt="devDependency Status" /></a>
<a href="https://coveralls.io/github/twbs/bootstrap?branch=v4-dev"><img src="https://img.shields.io/coveralls/github/twbs/bootstrap/v4-dev.svg" alt="Coverage Status" /></a>
<a href="https://github.com/twbs/bootstrap/tree/v4-dev/dist/css/bootstrap.min.css"><img src="https://img.badgesize.io/twbs/bootstrap/v4-dev/dist/css/bootstrap.min.css?compression=gzip&amp;label=CSS+gzip+size" alt="CSS gzip size" /></a>
<a href="https://github.com/twbs/bootstrap/tree/v4-dev/dist/js/bootstrap.min.js"><img src="https://img.badgesize.io/twbs/bootstrap/v4-dev/dist/js/bootstrap.min.js?compression=gzip&amp;label=JS+gzip+size" alt="JS gzip size" /></a>
...
<a href="#backers"><img src="https://opencollective.com/bootstrap/backers/badge.svg" alt="Backers on Open Collective" /></a>
<a href="#sponsors"><img src="https://opencollective.com/bootstrap/sponsors/badge.svg" alt="Sponsors on Open Collective" /></a></p>
...
<ol>
  <li>Run through the <a href="https://getbootstrap.com/docs/4.3/getting-started/build-tools/#tooling-setup">tooling setup</a> to install Jekyll (the site builder) and other Ruby dependencies with <code class="language-plaintext highlighter-rouge">bundle install</code>.</li>
...
<ul>
  <li>For v2.3.2: <a href="https://getbootstrap.com/2.3.2/">https://getbootstrap.com/2.3.2/</a></li>
  <li>For v3.3.x: <a href="https://getbootstrap.com/docs/3.3/">https://getbootstrap.com/docs/3.3/</a></li>
  <li>For v3.4.0: <a href="https://getbootstrap.com/docs/3.4/">https://getbootstrap.com/docs/3.4/</a></li>
  <li>For v4.0.x: <a href="https://getbootstrap.com/docs/4.0/">https://getbootstrap.com/docs/4.0/</a></li>
  <li>For v4.1.x: <a href="https://getbootstrap.com/docs/4.1/">https://getbootstrap.com/docs/4.1/</a></li>
  <li>For v4.2.x: <a href="https://getbootstrap.com/docs/4.2/">https://getbootstrap.com/docs/4.2/</a></li>
</ul>
...
<p>Editor preferences are available in the <a href="https://github.com/twbs/bootstrap/blob/master/.editorconfig">editor config</a> for easy use in common text editors. Read more and download plugins at <a href="https://editorconfig.org/">https://editorconfig.org/</a>.</p>
...
<p><a href="https://opencollective.com/bootstrap#backers"><img src="https://opencollective.com/bootstrap/backers.svg?width=890" alt="Bakers" /></a></p>
...
<p>Code and documentation copyright 2011-2019 the <a href="https://github.com/twbs/bootstrap/graphs/contributors">Bootstrap Authors</a> and <a href="https://twitter.com">Twitter, Inc.</a> Code released under the <a href="https://github.com/twbs/bootstrap/blob/master/LICENSE">MIT License</a>. Docs released under <a href="https://github.com/twbs/bootstrap/blob/master/docs/LICENSE">Creative Commons</a>.</p>
